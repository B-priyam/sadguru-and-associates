            ...
            <ul className="space-y-4">
              <li className="flex gap-3">
                ...
                <span className="text-primary-foreground/70">
                  <a
                    href="http://maps.google.com/?q=1200 Ornate Galaxy CHS LTD, B-Wing, Shop No. 116, 1st Floor, Tivri
                  Road, Naigaon East, 401208"
                  >
                    Ornate Galaxy CHS LTD, B-Wing, Shop No. 116, 1st Floor,
                    Tivri Road, Naigaon East, 401208
                  </a>
                </span>
              </li>
              <li className="flex gap-3">
              ...
              <li className="flex gap-3">
                ...
                <a
                  href="mailto:thesadguru.2025@gmail.com"
                  className="text-primary-foreground/70 hover:text-primary-foreground transition-colors text-sm"
                >
                  thesadguru.2025@gmail.com
                </a>
                <a
                  href="mailto:thesadguru.2026@homesinwesternline.in"
                  className="text-primary-foreground/70 hover:text-primary-foreground transition-colors text-sm"
                >
